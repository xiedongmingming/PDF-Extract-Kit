...
from layoutlmv3.layoutlmft.data.image_utils import Compose, RandomResizedCropAndInterpolationWithTwoPic
...
class xfund_dataset(Dataset):
    ...
    def __init__(
        ...
        data_file = json.load(
            open(os.path.join(args.data_dir, "{}.{}.json".format(self.cur_la, 'train' if mode == 'train' else 'val')), 'r', encoding="utf8")
        )
