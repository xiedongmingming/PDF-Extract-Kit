...
from layoutlmv3.layoutlmft import DataCollatorForKeyValueExtraction
from layoutlmv3.layoutlmft.data.xfund import xfund_dataset, XFund_label2ids
...
def main():
    #
    # see all possible arguments in layoutlmft/transformers/training_args.py or by passing the --help flag to this script.
    #
