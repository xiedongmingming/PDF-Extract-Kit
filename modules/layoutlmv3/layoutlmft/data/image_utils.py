...
class RandomResizedCropAndInterpolationWithTwoPic:
    ...
    def __init__(self, size, second_size=None, scale=(0.08, 1.0), ratio=(3. / 4., 4. / 3.), interpolation='bilinear', second_interpolation='lanczos'):
        #
    ...
    def __call__(self, img, augmentation=False, box=None):
        ...
        second_img = F.resize(img, self.second_size, self.second_interpolation) if self.second_size is not None else None
